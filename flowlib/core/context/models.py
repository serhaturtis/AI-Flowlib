...
class ContextSnapshot(StrictBaseModel):
    ...
    def create(cls, snapshot_id: int, model_data: StrictBaseModel) -> "ContextSnapshot":
        ...
        return cls(snapshot_id=snapshot_id, data=model_data, timestamp=datetime.now().isoformat())
...
class ContextData(StrictBaseModel):
    ...
    def create(cls, model_data: StrictBaseModel) -> "ContextData":
        ...
        return cls(model_data=model_data, model_type_name=model_data.__class__.__name__)
...
class ContextMergeRequest(StrictBaseModel):
    ...
    @classmethod
    def create(
        cls, primary: StrictBaseModel, secondary: StrictBaseModel, strategy: str = "overwrite"
    ) -> "ContextMergeRequest":
