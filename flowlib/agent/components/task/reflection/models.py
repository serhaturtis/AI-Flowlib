...
class LLMReflectionResult(StrictBaseModel):
    ...
    reasoning: str = Field(..., description="Analysis of what worked and what didn't work")
    ...
    replanning_guidance: str | None = Field(
        default=None, description="If next_action is 'replan', what should be done differently"
    )
    clarification_question: str | None = Field(
        default=None, description="If next_action is 'clarify', what to ask the user"
    )
...
class ReflectionResult(StrictBaseModel):
    ...
    replanning_guidance: str | None = None
