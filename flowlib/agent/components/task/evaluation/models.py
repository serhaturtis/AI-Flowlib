...
class LLMEvaluationResult(StrictBaseModel):
    """Evaluation result for task completion assessment."""

    is_complete: bool = Field(..., description="Whether the task is complete")
    completion_confidence: str = Field(..., description="Confidence level: low, medium, high")
    ...
    clarification_question: str | None = Field(
        default=None, description="Question to ask user if next_action is 'clarify'"
    )
