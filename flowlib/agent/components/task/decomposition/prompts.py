...
class DefaultPlanningPrompt(ResourceBase):
    ...
    - Create a plan with these fields:
      * plan_id: Generate a unique identifier
      * task_description: The task being planned
      * steps: List of execution steps, each with:
        - step_id: Unique identifier for the step
        - flow_name: Selected flow name from available flows
        - step_intent: Goal or purpose of this step
        - rationale: Reasoning for including this step
        - expected_outcome: What should result from this step
      * overall_rationale: Overall reasoning for the plan approach
    """
