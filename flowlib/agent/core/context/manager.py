...
class AgentContextManager(AgentComponent):
    ...
    async def create_execution_context(self,
        ...
        # Create component context with tool configurations
        component_context = ComponentContext(
            component_type=component_type,
            component_config=component_config,
            tool_configurations=await self._get_tool_configurations(),
        )
    ...
    async def _get_tool_configurations(self) -> Dict[str, Any]:
