...
class S3ListResponse(StrictBaseModel):
    ...
    NextContinuationToken: str | None = Field(None, description="Continuation token")
...
class S3UploadResponse(StrictBaseModel):
    ...
    VersionId: str | None = Field(None, description="Version ID if versioning enabled")
...
class S3DeleteResponse(StrictBaseModel):
    ...
    DeleteMarker: bool | None = Field(None, description="Whether delete marker was created")
    VersionId: str | None = Field(None, description="Version ID of deleted object")
