...
class InMemoryCacheProviderSettings(CacheProviderSettings):
    ...
    cleanup_interval: int = Field(
        default=300, description="Cleanup interval in seconds (5 minutes)"
    )
...
class MemoryCacheProvider(CacheProvider[InMemoryCacheProviderSettings]):
    ...
    def __init__(
        self, name: str = "memory-cache", settings: InMemoryCacheProviderSettings | None = None
    ):
        ...
        self._expiry: dict[str, float | None] = {}  # Maps keys to expiry times
