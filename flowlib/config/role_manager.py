...
class RoleManager:
    ...
    def assign_role(self, role_name: str, canonical_name: str) -> bool:
        ...
        Args:
            ...
            canonical_name: Canonical configuration name (validated lazily when accessed)
        ...
        Note:
            Validation of the canonical config is deferred until the role is actually accessed.
            This eliminates import order dependencies.
        """
    ...
    def reassign_role(self, role_name: str, new_canonical_name: str) -> bool:
        ...
        Args:
            ...
            new_canonical_name: New canonical configuration name (validated lazily when accessed)
        ...
        Note:
            Validation of the new canonical config is deferred until the role is actually accessed.
        """
        ...
        # Create new assignment without validation (validation happens at access time)
