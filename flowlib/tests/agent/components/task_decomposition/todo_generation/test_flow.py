...
from flowlib.agent.components.task_decomposition.todo_generation.flow import TodoGenerationFlow
...
class TestTodoGenerationFlow:
    ...
    async def test_run_pipeline_success(self, todo_generation_flow, sample_todo_generation_input, 
        ...
        # Mock dependencies
        with patch('flowlib.agent.components.task_decomposition.todo_generation.flow.provider_registry') as mock_provider_reg, \
             patch('flowlib.agent.components.task_decomposition.todo_generation.flow.resource_registry') as mock_resource_reg:
    ...
    async def test_run_pipeline_no_llm_provider(self, todo_generation_flow, sample_todo_generation_input):
        ...
        with patch('flowlib.agent.components.task_decomposition.todo_generation.flow.provider_registry') as mock_registry:
